                        ...
                        <div className="navbar__profile-dropdown">
                            ...
                            {isDropdownOpen && (
                                <div className="navbar__dropdown-menu">
                                    <Link to="/profile" className="navbar__dropdown-item" onClick={closeAllMenus}>Profile</Link>
                                    <LogoutButton className="navbar__dropdown-item navbar__dropdown-item--logout" onClick={closeAllMenus} />
                                </div>
                            )}
                        </div>
                    ) : (
                        <Link to="/login?redirect=/profile" className="navbar__login-btn" onClick={closeAllMenus} style={{ textDecoration: 'none' }}>
                            Login
                        </Link>
                    )}
