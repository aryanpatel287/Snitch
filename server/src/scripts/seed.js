  ...
  shirts: [
    {
      ...
      price: 999,
      description: "Blue textured casual shirt, has a spread collar, button placket, long regular sleeves, curved hem",
      images: [
    ...
    },
    {
      ...
      price: 999,
      description: "Navy blue opaque casual shirt. Spread collar, button placket, long sleeves, curved hemline",
      images: [
    ...
    },
    {
      ...
      price: 1127,
      description: "Mauve & white vertical stripes striped opaque Casual shirt, has a spread collar, button placket, long regular sleeves, high-low hem",
      images: [
    ...
    },
    {
      ...
      price: 1127,
      description: "Blue vertical stripes opaque Casual shirt, has a button-down collar, button placket, no pocket, long regular sleeves, curved hem",
      images: [
    ...
    },
    {
      ...
      price: 999,
      description: "White vertical striped casual shirt, has a button-down collar, button placket, long regular sleeves, curved hem",
      images: [
    ...
    },
    {
      ...
      price: 1129,
      description: "Black solid opaque Casual shirt, has a Spread Collar, button placket, pocket, short regular sleeves, curved hem",
      images: [
    ...
    },
    {
      ...
      price: 1099,
      description: "Black Solid Opaque Casual shirts, has a Spread Collar, Button Placket, 1 Patch pocket, Long Regular Sleeves, Curved hem",
      images: [
    ...
    },
    {
      ...
      price: 1399,
      description: "Blue Vertical Stripes Striped Opaque Casual shirts, has a Spread Collar, Button Placket, 1 Patch pocket, Long Regular Sleeves, Curved hem",
      images: [
    ...
    },
    {
      ...
      price: 743,
      description: "Beige opaque casual shirt. Button-down collar, button placket, long sleeves, curved hemline",
      images: [
  ...
  tshirts: [
    {
      ...
      price: 1176,
      description: "Off White Oversized T-shirt for Men with subtle chest embroidery, polo collar, and drop shoulder sleeves.",
      images: [
    ...
    },
    {
      ...
      price: 1499,
      description: "Black Polo T-shirt for Men, featuring a printed typography back graphic, long regular sleeves, and a premium collar.",
      images: [
    ...
    },
    {
      ...
      price: 599,
      description: "Olive green zip polo collar t-shirt with self design texture, short sleeves, and relaxed casual styling.",
      images: [
    ...
    },
    {
      ...
      price: 738,
      description: "White and brown structured t-shirt for men, solid pattern, regular length, polo collar, short drop-shoulder sleeves.",
      images: [
    ...
    },
    {
      ...
      price: 828,
      description: "Black and white textured daily tee, slim fit cotton fabric, polo collar, short sleeves, comfortable build.",
      images: [
    ...
    },
    {
      ...
      price: 1129,
      description: "Magenta solid casual tshirt, slim fit knit fabric with a front zip accent, short regular sleeves.",
      images: [
    ...
    },
    {
      ...
      price: 665,
      description: "Purple soft crewneck t-shirt for men, solid shade, regular length, drop-shoulder short sleeves, knitted pure cotton.",
      images: [
    ...
    },
    {
      ...
      price: 1299,
      description: "Textured weave white and brown t-shirt, relaxed drop-shoulder sleeves, polo neck collar, pure premium cotton.",
      images: [
    ...
    },
    {
      ...
      price: 682,
      description: "Beige crewneck tshirt for men featuring graphic chest and back prints, drop-shoulder short sleeves, premium knit.",
      images: [
  ...
  jeans: [
    {
      ...
      price: 1499,
      description: "Medium shade blue denim, low distress details, flared leg opening, mid-rise waist, vintage stonewashed style.",
      images: [
    ...
    },
    {
      ...
      price: 1899,
      description: "Dark shade charcoal black jeans, straight fit leg, clean look mid-rise waist, durable non-stretch denim, vintage wash.",
      images: [
    ...
    },
    {
      ...
      price: 1331,
      description: "Solid jet black straight-leg jeans, comfortable mid-rise stretch denim, 5 pockets configuration, regular length.",
      images: [
    ...
    },
    {
      ...
      price: 1151,
      description: "Coloured wash solid grey jeans, baggy wide-leg fit, mid-rise waist, 100% rigid cotton denim, clean layout.",
      images: [
    ...
    },
    {
      title: "Snitch Men Straight Fit Mid-Rise Light Fade Jeans",
      price: 1899,
      description: "Classic blue straight fit denim, vintage washed texture, mid-rise, cropped ankle length, non-stretch premium cotton.",
      images: [
    ...
    },
    {
      ...
      price: 1899,
      description: "Charcoal black baggy jeans, low distress details with a front seam design, 5 pockets layout, regular length.",
      images: [
    ...
    },
    {
      title: "Snitch Men Straight Fit Mid-Rise Light Fade Jeans",
      price: 1354,
      description: "Medium grey wash straight-leg jeans, clean look daily wear denim, non-stretch cotton material, regular length.",
      images: [
    ...
    },
    {
      ...
      price: 1393,
      description: "Stonewashed black baggy jeans, mildly distressed street styling, front seam accents, rigid cotton denim.",
      images: [
    ...
    },
    {
      ...
      price: 1121,
      description: "Classic blue utility cargo jeans, baggy relaxed wide leg, mid-rise, 6 pockets layout, zip and button fly.",
      images: [
  ...
  for (let i = 0; i < productsList.length; i++) {
    ...
    try {
      ...
      for (let j = 0; j < item.images.length; j++) {
        ...
        console.log(`   Downloading image ${j + 1}/${item.images.length}...`);
        const buffer = await downloadImage(imageUrl);
        
        console.log(`   Uploading image ${j + 1}/${item.images.length} to ImageKit...`);
      ...
      if (uploadedImages.length === 0) {
        throw new Error("No images were successfully uploaded for this product.");
      }
      ...
      console.error(`   Error seeding product "${item.title}":`, error.message);
    }
  }
}
